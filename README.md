...
本项目是 **疾病防控综合系统**，采用主流 Java Web 技术栈开发，功能完整、结构清晰，非常适合作为毕业设计或课程设计的参考源码。

**仓库名**：`java-project-174-springboot-bing-fang-kong-zong-he`

**原始压缩包名**：`springboot174基于springboot的疾病防控综合系统的设计与实现`
